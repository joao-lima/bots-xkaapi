...
void sparselu_init_seq(float ***pM, char *pass);
void sparselu_init_par(float ***pM, char *pass);
void sparselu_fini(float **M, char *pass);
void sparselu_seq_call(float **SEQ);
void sparselu_par_call(float **BENCH);
int sparselu_check(float **SEQ, float **BENCH);

#define KERNEL_INIT sparselu_init_par(&BENCH,"benchmark");
#define KERNEL_CALL sparselu_par_call(BENCH);
#define KERNEL_FINI sparselu_fini_par(BENCH,"benchmark");

#define KERNEL_SEQ_INIT sparselu_init_seq(&SEQ,"serial");
#define KERNEL_SEQ_CALL sparselu_seq_call(SEQ);
#define KERNEL_SEQ_FINI sparselu_fini_seq(SEQ,"serial");
